...
export default function Navigation() {
    ...
    return (
        <div className="navigation-component flex flex-col justify-between gap-10 mobile:border-r mobile:border-primary p-5 mobile:min-h-dvh min-w-65 max-mobile:w-full max-mobile:absolute max-mobile:bottom-5 max-mobile:border-t-2 max-mobile:border-white">
